                 ...
                 tabPanel("Graphique",fluidPage(),
                          ...
                          pageWithSidebar(headerPanel(''),
                                          sidebarPanel(
                                            ...
                                            div(style="display: inline-block;vertical-align:bottom",numericInput("beginning","Début",1914)),
                                            div(style="display: inline-block;vertical-align:bottom",numericInput("end","Fin",1920)),
